...
class Crud extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $iconName = is_file($iconPath) && stripos(file_get_contents($iconPath), '@rt-var-' . $table . ':') ? 'fa rt-' . $table : 'fa rt-circle-o';
...
<div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="plupload-{$field}" class="btn btn-danger plupload" data-input-id="c-{$field}"{$uploadfilter}{$multiple}{$preview}><i class="fa rt-upload"></i> {:__('Upload')}</button></span>
                    <span><button type="button" id="fachoose-{$field}" class="btn btn-primary fachoose" data-input-id="c-{$field}"{$selectfilter}{$multiple}><i class="fa rt-list"></i> {:__('Choose')}</button></span>
                </div>
