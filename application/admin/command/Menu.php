...
class Menu extends Command
{
    ...
    protected function importRule($controller)
    {
        ...
        $uniqueName = uniqid("qya") . $classSuffix;
        ...
        foreach ($controllerArr as $k => $v)
        {
            ...
            $icon = (!isset($controllerArr[$key]) ? $controllerIcon : 'fa rt-list');
        ...
        foreach ($methods as $m => $n)
        {
            ...
            $ruleArr[] = array('id' => $id, 'pid' => $pid, 'name' => $name . "/" . strtolower($n->name), 'icon' => 'fa rt-circle-o', 'title' => $title, 'ismenu' => 0, 'status' => 'normal');
        }
