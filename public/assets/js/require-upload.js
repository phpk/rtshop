define(['jquery', 'bootstrap', 'plupload', 'template'], function ($, undefined, Plupload, Template) {
    var Upload = {
        ...
        config: {
            ...
            previewtpl: '<li class="col-xs-3"><a href="<%=fullurl%>" data-url="<%=url%>" target="_blank" class="thumbnail"><img src="<%=fullurl%>" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa rt-trash"></i></a></li>',
        },
        events: {
            //初始化完成
                    ...
                    Upload.list[id] = new Plupload.Uploader({
                        ...
                        init: {
                            ...
                            UploadProgress: function (up, file) {
                                ...
                                $(button).prop("disabled", true).html("<i class='fa rt-upload'></i> " + __('Upload') + file.percent + "%");
                            },
