            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<i class="fa rt-calendar glyphicon glyphicon-calendar"></i>' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fa rt-clock-o glyphicon glyphicon-time"></i>' +
                      '</div>' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="fa rt-' + arrow.left + ' glyphicon glyphicon-' + arrow.left + '"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="fa rt-' + arrow.right + ' glyphicon glyphicon-' + arrow.right + '"></i></th>';
            } else {
                html += '<th></th>';
            }
    ...
    _add = function (opts) {
        ...
        if ($("#" + tabid).size() == 0) {
            ...
            if (options.close && $("li", navobj).size() > 0) {
                title.append(' <i class="close-tab fa rt-remove"></i>');
            }
            //创建新TAB的内容
...
(function (factory) {
    ...
    SelectPage.prototype.setElem = function (combo_input, option) {
        ...
        if (option.multiple) {
            if (option.multipleControlbar) {
                $(elem.control).append('<button type="button" class="btn btn-default sp_select_all" ><i class="fa rt-check-square-o"></i> 全选本页</button>');
                $(elem.control).append('<button type="button" class="btn btn-default sp_unselect_all" ><i class="fa rt-square-o"></i> 取消本页</button>');
                $(elem.control).append('<button type="button" class="btn btn-default sp_clear_all" ><i class="fa rt-ban"></i> 清除全部</button>');
    ...
    SelectPage.prototype.showMessage = function (self, msg) {
        if (!msg)
            return;
        var msgLi = '<li class="sp_message_box"><i class="fa rt-exclamation-triangle"></i> ' + msg + '</li>';
    ...
    SelectPage.prototype.setNavi = function (self, cnt_whole, cnt_page, page_num) {
        ...
        var buildPageNav = function (self, pagebar, page_num, last_page) {
            if ($('li', $(pagebar)).size() == 0) {
                ...
                //为不同版本图标设置样式
                var iconFist = 'fa rt-angle-double-left', iconPrev = 'fa rt-angle-left', iconNext = 'fa rt-angle-right', iconLast = 'fa rt-angle-double-right';
                if (!isNewFontAwesome) {
    ...
    SelectPage.prototype.displayResults = function (self, json, is_query) {
        ...
        if (json.candidate.length > 0) {
            ...
            var li = '<li class="sp_message_box"><i class="fa rt-exclamation-triangle"></i> ' + self.message.not_found + '</li>';
